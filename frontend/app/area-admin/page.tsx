...
import { useRouter } from 'next/navigation'; // Importação correta do useRouter no Next.js 13+
import Link from 'next/link';
import { FiUsers, FiClipboard, FiSettings } from 'react-icons/fi'; // Ícones para melhorar a interface
...
export default function AreaDoAdmin() {
    ...
    useEffect(() => {
        ...
        if (userRole && userEmail && userRole === 'Admin') {
            ...
            // Se o token estiver presente, mas o usuário não for admin, redireciona para o login
            router.push('/login');
        }
